...
class ModalOrder {
  constructor() {
    ...
    this.modalOrderOverlay = document.querySelector(
      "[data-js-modalOrder-overlay]",
    )
  ...
  closeModalBasket() {
    document
      .querySelector("[data-js-basket-overlay]")
  ...
  renderModalOrder(data) {
    ...
    const modalOrdertItemsHtml = data
      .map((product) => {
