class Slider {
    ...
    constructor() {
        ...
        this.minNumberElement = this.rootElement.querySelector(this.selectors.minNumber);
        this.maxNumberElement = this.rootElement.querySelector(this.selectors.maxNumber);
        this.minRangeElement = this.rootElement.querySelector(this.selectors.minRange);
        this.maxRangeElement = this.rootElement.querySelector(this.selectors.maxRange);
